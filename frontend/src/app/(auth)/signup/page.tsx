...
export default function SignupPage() {
  ...
  return (
    <div className="relative flex min-h-dvh flex-col px-6 overflow-hidden">
      {/* Living network — carries the visual language from the welcome page */}
      ...
      <div className="relative z-10 my-auto w-full">
        <div className="animate-fade-up mb-10">
          <h1 className="text-large-title text-white">Get started</h1>
        ...
        <form onSubmit={handleSignup} className="animate-fade-up delay-200 flex flex-col gap-4">
          <div>
            <label htmlFor="name" className="mb-2 block text-footnote text-white/35">
              Full name
            </label>
            <input
              id="name"
      ...
      <div className="animate-fade-in delay-400 relative z-10 pb-10 pt-8 text-center">
        <p className="text-subhead text-white/25">
          ...
          <Link href="/login" className="font-semibold text-white/50 active:text-white/80">
            Sign in
          </Link>
        </p>
      </div>
